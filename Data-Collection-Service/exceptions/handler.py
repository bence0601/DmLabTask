...
from exceptions.custom_exception import ApiKeyInvalid, ApiKeyNotFound, DataCollectionServiceException
...
def register_error_handler(app):
    ...
    def handle_data_collection_exception(error):
        """Catch-all for any DataCollectionServiceException not handled above"""
